...
NSString *const kGPUimageLocalRGBFilterString = SHADER_STRING
(
...
@implementation GPUimageLocalRGBFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUimageLocalRGBFilterString]))
    {
        return nil;
    }
